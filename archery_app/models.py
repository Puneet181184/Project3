...
class  archery_db(models.Model):
   ...
   arrowlength=models.CharField(max_length=512,null=True)
   drawweight=models.CharField(max_length=512,null=True)
   averagearrow=models.CharField(max_length=512,null=True)
