...
def add_entry(name,age,country,height,weight,position):     

	t=handball_db.objects.get_or_create(name=name,age=age,country=country,height=height,weight=weight,position=position)[0]
	t.save()
...
#open csv file
csvfile=open("handball_players.csv","r")
