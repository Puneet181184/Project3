...
urlpatterns=[
  ...
  re_path(r'form_po/',views.form_positionstats,name='form_positionstats'),
  re_path(r'form_poi/',views.form_pointstats,name='form_pointstats'),
  ...
  re_path(r'search_po/',views.search_positionstats,name='search_positionstats'),
  re_path(r'search_poi/',views.search_pointstats,name='search_pointstats'),
