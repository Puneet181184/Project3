    ...
    if request.method=="POST":
      ...
      if form.is_valid():
         ...
         try:
             ...
             return render(request,"cycling_app/error_about.html")
         return render(request,"cycling_app/result_about.html",context={"player":my_value})
      else:
         print(" error form invalid")
    return render(request,"cycling_app/search_about.html",{"form":form})
    ...
    if request.method=="POST":
      ...
      if form.is_valid():
         ...
         try:
             ...
             return render(request,"cycling_app/error_details.html")
         return render(request,"cycling_app/result_details.html",context={"player":my_value})
      else:
         print(" error form invalid")
    return render(request,"cycling_app/search_details.html",{"form":form})
    ...
    if request.method=="POST":
      ...
      if form.is_valid():
         ...
         try:
             ...
             return render(request,"cycling_app/error_gamestats.html")
         return render(request,"cycling_app/result_gamestats.html",context={"player":my_value})
      else:
         print(" error form invalid")
    return render(request,"cycling_app/search_gamestats.html",{"form":form})
    ...
    if request.method=="POST":
      ...
      if form.is_valid():
         ...
         try:
             ...
             return render(request,"cycling_app/error_pointstats.html")
         return render(request,"cycling_app/result_pointstats.html",context={"player":my_value})
      else:
         print(" error form invalid")
    return render(request,"cycling_app/search_pointstats.html",{"form":form})
